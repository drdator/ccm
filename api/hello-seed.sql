...
VALUES (1, 'hello', '1.0.0', 'A simple greeting command to test the CCM system', 'https://github.com/ccm-org/hello', 'MIT', 'https://claudecommands.dev', 'greeting', 1, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- Insert hello command file
...
Happy coding with Claude!', 'hello-hash-1');

-- Insert tags
INSERT OR REPLACE INTO tags (command_id, tag) VALUES
(1, 'greeting'), (1, 'hello'), (1, 'welcome'), (1, 'test');